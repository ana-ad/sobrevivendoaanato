document.addEventListener("DOMContentLoaded", function() {
  ...
  let structures = [
    ...
    "Pré--maxilar",
    "Lacrimal",
    "Processo pré-orbital do frontal",
    "Côndilo occipital",
    "Exoccipital",
    "Esquamosal",
    "Arco temporal",
    ...
    "Parietal",
    "Supraoccipital",
    "Processo pré-orbital do lacrimal",
    "Crista temporal"
  ];
  ...
  function resetQuiz() {
    if (questionCounter === totalQuestions) {
      ...
      document.body.appendChild(indexLink); // Adicionar o link para a página principal ao corpo do documento
    } else {
