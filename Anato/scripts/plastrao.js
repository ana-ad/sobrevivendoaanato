document.addEventListener("DOMContentLoaded", function() {
  ...
  indexLink.href = "index.html"; // Definir o destino do link para a página principal
  ...
  let structures = [
    ...
    "Hipoplastrão",
    "Xifoplastrão",
    "Plastrão dérmico gular",
    "Plastrão dérmico umeral",
    "Plastrão dérmico peitoral",
    "Plastrão dérmico abdominal",
    "Plastrão dérmico femural",
    "Plastrão dérmico anal"
  ];
  ...
  function resetQuiz() {
    if (questionCounter === totalQuestions) {
      ...
      question.appendChild(indexLink); // Adicionar o link para a página principal
    } else {
