document.addEventListener("DOMContentLoaded", function() {
  ...
  let structures = [
    "Amblengs",
  "Femorotibial - corte A",
  "Femorotibial - corte B",
  "Flexor tibial externo - corte A",
  "Flexor tibial externo - corte B",
  "Tibial interno",
  "Gastrocnêmio - corte A",
  "Gastrocnêmio - corte B",
  "Flexor longo dos dígitos - corte A",
  "Flexor longo dos dígitos - corte B",
  "Flexor longo dos dígitos - corte C",
  "Tibial - corte A",
  "Tibial - corte B",
  "Tibial anterior - corte A",
  "Tibial anterior - corte B",
  "Tibial anterior - corte C",
  "Ambiana",
  "Pubotibial",
  "Puboisquial"
  ];
  ...
  let structuresC = structures.filter(structure => structure.includes("corte C"));
  let otherStructures = structures.filter(structure => !structure.includes("corte A") && !structure.includes("corte B") && !structure.includes("corte C"));
  ...
  structures = structuresA.concat(structuresB, structuresC, otherStructures);
