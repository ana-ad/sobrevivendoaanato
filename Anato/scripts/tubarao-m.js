document.addEventListener("DOMContentLoaded", function() {
  ...
  let structures = [
    "Nadadeira anal",
  "Nadadeira caudal",
  "Nadadeira dorsal posterior",
  "Nadadeira dorsal anterior",
  "Nadadeira pélvica",
  "Nadadeira peitoral",
  "M. epaxial do tronco",
  "M. hipaxial do tronco",
  "M. parietal epaxial",
  "Feixe dorsal longitudinal (epaxial)",
  "Feixe lateral longitudinal (hipaxial)",
  "Feixe ventral longitudinal (hipaxial)"
  ];
