document.addEventListener("DOMContentLoaded", function() {
  ...
  const indexLink = document.createElement('a'); // Criar elemento de link
  indexLink.href = "index.html"; // Definir o destino do link para o índice
  indexLink.textContent = "Voltar para página principal"; // Definir o texto do link
  let structures = ["Forame Mentoniano", "Fossa Massetérica", "Dentário", "Processo Esquamosal-jugal", "Nasal", "Pré-maxilar", "Maxilar", "Julgal", "Processo Julgal-Esquamosal", "Forame infraorbital", "Forame Lacimal", "Lacrimal", "Processo Frontal-Julgal", "Côndilo occiptal", "Occipital", "Crista nucal", "Esquamosal", "Parietal", "Processo coronóide", "Frontal", "Processo condilar", "Processo jugal-frontal", "Crista sagital externa"];
  ...
  function resetQuiz() {
    if (questionCounter === totalQuestions) {
      ...
      // Adicionar o link para o índice
      indexLink.setAttribute("class", "voltar-link")
      question.appendChild(indexLink);
    } else {
